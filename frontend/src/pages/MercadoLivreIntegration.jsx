...
const setupSteps = [
  ...
  },
  {
    ...
    text: "Clique em Conectar Mercado Livre, faca login e autorize a NEXT ERP a acessar a conta.",
  },
];
    ...
    <div className="page shopee-page">
      <section className="shopee-hero">
        <div>
          ...
          <p>
            Conecte a conta do Mercado Livre via OAuth para a NEXT ERP acessar
